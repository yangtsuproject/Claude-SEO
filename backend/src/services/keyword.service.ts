...
export class KeywordService {
   ...
   * 2. Cluster keywords with Claude AI
   * 3. Save everything to database
   */
  async processKeywordResearch(keywordResearchId: string): Promise<void> {
    try {
      ...
      console.log('📊 Step 1: Fetching keyword data...');
      const keywordData = await this.dataForSEO.batchGetKeywordData(
      ...
      // Step 2: Cluster keywords with Claude AI
      console.log('🤖 Step 2: Clustering keywords with AI...');
      ...
      // Step 3: Save keywords and clusters to database
      console.log('💾 Step 3: Saving to database...');
      await this.saveKeywordsAndClusters(keywordResearchId, keywordData, clusteringResult);
